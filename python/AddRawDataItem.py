...
def argument_parser():
    ...
    requiredNamed.add_argument('-f', '--file', action='store', help='Input file/directory name to copy. For point clouds of sites specify the path to the LAS/LAZ file. For background point clouds specify the folder. For pictures the path to the png/jpg/jpeg file. For meshes specify the path to the OBJ file (the textures contained in the same folder as the OBJ will also be copied)', required=True)
